            ...
            content=ft.Column(
                [
                    ...
                    ft.Container(
                        content=ft.Row(
                            [
                                ft.Icon(ft.ft.icons.PERSON, color=Colors.PRIMARY, size=30),
                                ft.Column(
                                    [
                                        ft.Text(
                            ...
                            [
                                ...
                                ft.Row(
                                    [
                                        ...
                                        self.create_menu_item(
                                            "CONTRATOS",
                                            ft.ft.icons.DESCRIPTION,
                                            Colors.SECONDARY,
                                            lambda _: self.navigate_to("contratos")
                                        ),
                                        self.create_menu_item(
                                            "PROMOÇÃO",
                                            ft.ft.icons.CAMPAIGN,
                                            Colors.SECONDARY,
                                ...
                                ft.Row(
                                    [
                                        self.create_menu_item(
                                            "CADASTRAR\nCLIENTE",
                                            ft.ft.icons.PERSON_ADD,
                                            Colors.SECONDARY,
                                            lambda _: self.navigate_to("cadastro_cliente")
                                        ),
                                        self.create_menu_item(
                                            "NOTIFICAÇÃO",
                                            ft.ft.icons.NOTIFICATIONS,
                                            Colors.SECONDARY,
                    ...
                    ft.Container(
                        content=ft.Row(
                            [
                                ...
                                ft.IconButton(
                                    ft.ft.icons.PHOTO_CAMERA,
                                    icon_color=Colors.WHITE,
                                    bgcolor=Colors.SUCCESS,
                                    icon_size=30,
                                ),
                                ft.IconButton(
                                    ft.ft.icons.THUMB_UP,
                                    icon_color=Colors.WHITE,
                                    bgcolor=Colors.SUCCESS,
                                    icon_size=30,
                                ),
                                ft.IconButton(
                                    ft.ft.icons.PLAY_ARROW,
                                    icon_color=Colors.WHITE,
                                    bgcolor=Colors.SUCCESS,
                                    icon_size=30,
                                ),
